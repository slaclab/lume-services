...
def generate_schema_graph(output_filename: str, show_datatypes: bool =True, show_indexes: bool =True, rankdir: str ='LR', concentrate: bool =True) -> None:
...
def generate_uml_graph(output_filename: str):
    ...
    # compile mappers
    mappers = [class_mapper(x) for x in [Model, Deployment, Flow, FlowToDeployments, Project]]
